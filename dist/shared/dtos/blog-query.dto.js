...
exports.BlogQueryDto = exports.Sort = void 0;
...
class BlogQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, minimum: 1 }, limit: { required: false, type: () => Number, minimum: 1 }, title: { required: false, type: () => String }, sort: { required: false, enum: require("./blog-query.dto").Sort } };
    }
}
